var BanTimeline = {
  ...
  reset: function () {
      ...
      TweenLite.to(frame2txt, 0, {opacity:0,top:20});
      TweenLite.to(frame3txt, 0, {opacity:0,top:20});
      TweenLite.to(frame4txt, 0, {opacity:0,top:20});
      TweenLite.to(frame5txt, 0, {opacity:0,top:20});
