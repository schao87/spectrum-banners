var BanTimeline = {
  ...
  reset: function () {
      ...
      TweenLite.to(frame2txt, 0, {opacity:0, left:200});
      TweenLite.to(frame3txt, 0, {opacity:0, left:200});
      TweenLite.to(frame4txt, 0, {opacity:0, left:200});
  ...
  frame1: function () {
    TweenLite.to(frame1txt, .5, {opacity:0, left:-200, delay:2.5});
    TweenLite.delayedCall(2.7, BanTimeline.frame2); 
  },
  frame2: function () {
    TweenLite.to(frame2txt, .5, {opacity:1, left:0});
    TweenLite.to(frame2txt, .5, {opacity:0, left:-200, delay:2.5});
    TweenLite.delayedCall(2.7, BanTimeline.frame3);
  },
  frame3: function () {
    TweenLite.to(frame3txt, .5, {opacity:1, left:0});
    TweenLite.to(frame3txt, .5, {opacity:0, left:-200, delay:2.5});
    TweenLite.delayedCall(2.7, BanTimeline.frame4);
  },
  frame4: function () {
