var BanTimeline = {
  ...
  reset: function () {
      ...
      TweenLite.to(frame2txt, 0, {opacity:0,top:5});
      TweenLite.to(frame3txt, 0, {opacity:0,top:5});
      TweenLite.to(frame4txt, 0, {opacity:0,top:5});
      TweenLite.to(frame5txt, 0, {opacity:0,top:5});
  ...
  frame1: function () {
    TweenLite.to(frame1txt, .5, {opacity:0, top:-5, delay:2.5});
    TweenLite.delayedCall(2.5, BanTimeline.frame2); 
  },
  frame2: function () {
    TweenLite.to(frame2txt, .5, {opacity:1, top: 0});
    TweenLite.to(header, .5, {opacity:1});
    TweenLite.to(frame2txt, .5, {opacity:0, top:-5, delay:2.5});
    TweenLite.delayedCall(2.5, BanTimeline.frame3);
  },
  frame3: function () {
    TweenLite.to(frame3txt, .5, {opacity:1, top:0});
    TweenLite.to(frame3txt, .5, {opacity:0, top:-5, delay:2.5});
    TweenLite.delayedCall(2.5, BanTimeline.frame4);
  },
  frame4: function () {
    TweenLite.to(frame4txt, .5, {opacity:1, top:0});
    TweenLite.to(frame4txt, .5, {opacity:0, top:-5, delay:2.5});
    TweenLite.delayedCall(2.5, BanTimeline.frame5);
  },
  frame5: function () {
    TweenLite.to(frame5txt, .5, {opacity:1, top:0});
    TweenLite.to(frame5txt, .5, {opacity:0, top:-5, delay:2.5});
    TweenLite.to(header, .5, {opacity:0, delay:2.5});
    TweenLite.delayedCall(2.5, BanTimeline.frame6);
  },
  frame6: function () {
