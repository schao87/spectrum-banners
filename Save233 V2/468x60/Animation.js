var BanTimeline = {
  ...
  reset: function () {
      ...
      TweenLite.to(frame5txt, 0, {opacity:0});
      TweenLite.to(header, 0, {opacity:1});
  ...
  replayFunction: function () {
        ...
        replay_container.onmouseover = function () {
          TweenLite.to(replay_icon, 1, {rotation: -360, transformOrigin:"50% 58%"});
        }
  ...
  frame5: function () {
    TweenLite.to(frame5txt, .5, {opacity:1});
