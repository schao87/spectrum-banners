home_animation = (function() {
	...
	function resetFunction(){
		TweenLite.to(tv_internet_frame1, 0, {top:103});
		TweenLite.to(the_season_frame_1, 0, {top:0});
	...
	function frame1()
	{
		TweenLite.to(the_season_frame_1, 0.7, {top:-121, ease:Sine.easeOut, delay:2});
		TweenLite.to(tv_internet_frame1, 0.7, {top:0, ease:Sine.easeOut, delay:2.1});
	...
	{	
		...
		TweenLite.to(no_contract, 0.2, {opacity: 0, delay: 2.6});
